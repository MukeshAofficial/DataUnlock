...
async def gemini_session_handler(client_websocket: websockets.WebSocketServerProtocol):
    ...
    try:
        ...
        Do not mention your operations like "I am searching the document now" the documet is an knowledge base of an company so the questions will be mostly company related.
        """
